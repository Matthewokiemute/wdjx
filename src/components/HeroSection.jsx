...
const HeroSection = () => {
  ...
  return (
    <div className="px-4 my-16 lg:my-20 lg:px-40 ">
      ...
      <h1
        className="text-2xl md:text-3xl lg:text-[85px] font-bold mb-5 lg:mb-10 text-white leading-[60px] -tracking-wide"
        // data-aos="fade-up"
        // data-aos-delay="400"
      >
       ...
       <span className="text-pink">conference</span> <span className="text-blue">in warri</span>.
      </h1>
      <p
      ...
      <button
        class="flex items-center space-x-1 bg-primary text-black text-[18px] px-6 py-4 hover:opacity-80 ease-in duration-200 rounded-md"
        // data-aos="fade-up"
        // data-aos-delay="800"
      >
        <a href="#register">
