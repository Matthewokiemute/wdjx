...
const HeroSection = () => {
  ...
  return (
    <div className="relative px-4 my-16 lg:my-20 lg:px-40">
      <p className="mb-2 lg:mb-4 md:text-[17px] text-[#fff] lg:w-3/4 font-semibold">
      ...
      <button
        ...
        // data-aos-delay="800"
      >
        <a href="#register">Make I secure my sit first</a>
