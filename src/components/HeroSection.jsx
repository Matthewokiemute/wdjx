...
const HeroSection = () => {
  return (
    <div className="mx-3 my-10 lg:my-20 lg:px-40 ">
      <h1 className="text-5xl md:text-6xl lg:text-8xl font-medium mb-5 lg:mb-10 text-white" data-aos="fade-up" data-aos-delay="400">
        The First Waffi <br className="hidden lg:inline-block" />
        Design Conference
      </h1>
      <p className="mb-5 lg:mb-10 md:text-[17px] text-[#ddd] lg:w-3/4" data-aos="fade-up" data-aos-delay="600">
      ...
      <button class="flex items-center space-x-1 bg-[#FFC800] text-black text-[18px] px-6 py-4 hover:opacity-80 ease-in duration-200" data-aos="fade-left" data-aos-delay="800">
