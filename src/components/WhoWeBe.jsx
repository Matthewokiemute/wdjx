...
const WhoWeBe = () => {
  return (
    <div className="mx-auto flex flex-col lg:flex-row items-center justify-between w-3/4">
        <Image src="/images/shot.png" width={500} height={500} className="object-cover mb-6 lg:hidden" />
      ...
      <div className="w-full lg:w-1/2">
        <Image src="/images/shot.png" width={600} height={600} className="object-cover mb-6 hidden lg:inline-block animate-b" />
        <div className="-ml-8">
